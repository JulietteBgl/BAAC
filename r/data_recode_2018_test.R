...
# Import du fichier
caract <- read.csv(file = "data/2018/caracteristiques-2018.csv", header = TRUE, sep = ",")
...
# Import du fichier
vehic <- read.csv(file = "data/2018/vehicules-2018.csv", header = TRUE, sep = ",")
...
# Import du fichier
usag <- read.csv(file = "data/2018/usagers-2018.csv", header = TRUE, sep = ",")
...
# Import du fichier
lieux <- read.csv(file = "data/2018/lieux-2018.csv", header = TRUE, sep = ",")
