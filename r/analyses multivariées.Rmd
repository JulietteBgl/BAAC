...
## Comparaison du % de gravité de l'accident selon la catégorie d'usager

## Impact de la luminosité sur le nombre d'accident
...
## Scatterplot taux de mortalité vs âge
...
usag %>% 
  ...
  geom_point(aes(size = nb_acc_age)) +
  labs(
    x = "Âge",
    y = "Taux de mortalité",
...
## Boxplots taux mortalité Conducteurs vs piétons vs passager
...
usag %>% 
  ...
  labs(
    x = "",
    y = "Taux de mortalité (%)",
    title = "Taux de mortalité par catégorie d'usager"
  )
```

## idem avec aggregation tué et hospitalisé
```{r}
usag %>% 
  group_by(catu) %>% 
  mutate(nb_acc_cat = n(),
  ...
  labs(
    ...
    title = "Taux d'accidents graves par catégorie d'usager"
  )
```
...
Distribution des accidents selon la voie
boxplot taux mortalité / boxplot gravité
...
## Distribution des accidents par type de véhicules utilisé 
...
# Quels sont les plus grosses sources de danger pour les piétons ?
